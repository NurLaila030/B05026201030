...
class MaskerController extends Controller
{
    ...
    //	$masker = DB::table('masker')->get();
       $masker = DB::table('masker')->paginate(5);
    	...
    	// mengirim data masker ke view masker
    ...
    public function edit($kodemasker)
    {
        // mengambil data masker berdasarkan kodemasker yang dipilih
        $masker = DB::table('masker')->where('kodemasker',$kodemasker)->get();
        // passing data masker yang didapat ke view edit.blade.php
        return view('masker.edit',['masker' => $masker]);
    }
    public function view($kodemasker)
    {
	// mengambil data masker berdasarkan kodemasker yang dipilih
	$masker = DB::table('masker')->where('kodemasker',$kodemasker)->get();
	// passing data masker yang didapat ke view edit.blade.php
    ...
    public function hapus($kodemasker)
    {
        // menghapus data masker berdasarkan kodemasker yang dipilih
        DB::table('masker')->where('kodemasker',$kodemasker)->delete();
